...
Entity::Entity() {
    ...
    stamina.fullColor.r = 0xF0;
    stamina.fullColor.g = 0xF0;
    stamina.fullColor.b = 0x00;
    stamina.partColor.r = 0x88;
    stamina.partColor.g = 0x44;
    stamina.partColor.b = 0x00;
    stamina.emptyColor = health.emptyColor; // black
