#ifndef NOISEGEN_CUH
#define NOISEGEN_CUH
// Modified from libnoise, see below
...
namespace cuda_noise {

    __device__
    double GetPerlinValue (double x, double y, double z, int seed);

    __device__
    double GetRidgedMultiValue(double x, double y, double z, int seed);
